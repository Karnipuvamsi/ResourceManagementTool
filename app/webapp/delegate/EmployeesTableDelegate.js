sap.ui.define([
    ...
    /**
     * Employees Table Delegate
     * Extends BaseTableDelegate with Employees-specific logic
     */
    ...
    // Only override if Employees-specific logic is needed

    // ✅ Employees-specific: Override updateBindingInfo to add Supervisor expansion and Res table filter
    ...
    EmployeesTableDelegate.getFilterDelegate = function () {
        return {
            addItem: function (vArg1, vArg2, vArg3) {
                ...
                return EmployeesTableDelegate.fetchProperties(oTable).then((aProperties) => {
                    ...
                    // ✅ DO NOT set caseSensitive - it's not a valid property for FilterField (case sensitivity is handled in filter logic)
                    ...
                    return new FilterField({
                        ...
                        // ✅ DO NOT set caseSensitive - not a valid FilterField property
                    });
                }).catch(() => {
